...
public class StringHashCodeIntrinsic {
    ...
    private static volatile VarHandle hashHandle;
    private static volatile VarHandle hashIsZeroHandle;
    ...
    private static void initVarHandles() throws ReflectiveOperationException {
        if (hashHandle != null && hashIsZeroHandle != null) {
            return;
        }
        synchronized (StringHashCodeIntrinsic.class) {
            if (hashHandle == null || hashIsZeroHandle == null) {
                ...
                hashHandle = lookup.findVarHandle(String.class, "hash", int.class);
                hashIsZeroHandle = lookup.findVarHandle(String.class, "hashIsZero", boolean.class);
            }
        }
    }

    private static void resetHash(String s) {
        hashHandle.set(s, 0);
        hashIsZeroHandle.set(s, false);
    }
