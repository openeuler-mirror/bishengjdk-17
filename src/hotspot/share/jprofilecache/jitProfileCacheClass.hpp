...
public:
  ProfileCacheClassEntry(ProfileCacheClassHolder* holder, unsigned int hashValue, Symbol* value)
      : HashtableEntry(hashValue, value),
        _head_holder(holder),
        _chain_offset(-1),
  ...
  ProfileCacheClassEntry(unsigned int hashValue, Symbol* value)
      : HashtableEntry(hashValue, value),
